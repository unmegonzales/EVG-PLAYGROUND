...
CONCEPTS = [
    ...
    },
    {
        ...
        "status": "Ready for review",
        "status_key": "ready",
        "pitch": "Bob King’s line — “When you came down the ramp, it’s quite a feeling” — set as a commemorative coin on a cherry-duotone ramp / newsprint wrap.",
        "lockup": "Front coin, ~2 in. diameter",
        "rights": "Yes. Historic photos must come from UNM Athletics archives.",
        "colors": "Newsprint cream · Cherry · Black · Silver",
        "notes": [
            "Strongest emotional board for alumni and season-ticket holders.",
            "Current photography is labeled placeholder until rights are cleared.",
            "Pairs well with The Opening as a two-SKU legacy set.",
        ],
    },
    {
        "id": "03",
